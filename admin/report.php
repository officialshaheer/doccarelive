<?php 
    ...
    $sql = 'select * from commission where app_id in ( select app_id from appointment where appdef_id in ( select appdef_id from appointment_definition  ) )';
    ...
    <div class="col-md-12">
        <div class="panel panel-bordered">
            ...
            <div class="panel-body">
                ...
                <div id="jsGrid"></div>
                <b>Total Revenue : <?php echo $total; ?></b>
            </div>
        </div>
    </div>
</div>
