<?php 
    ...
    $db=new Database(); 
    if( isset( $_GET['id'] ) ) {
        $sql='select * from patient where patient_id = "' . $_GET['id'] .  '" and patient_id in ( select patient_id from  appointment where appdef_id in (select appdef_id from appointment_definition where doctor_id = ' . $_COOKIE['userid'] . ' ) )' ; 
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-bordered">
            <div class="panel-heading">
                <h3 class="panel-title">Patient - <?php echo ucfirst($patient['fname'] . ' ' . $patient['lname']); ?></h3>
    ...
    <?php } else { echo '<div class="alert alert-danger">No reference found!</div>';} ?>
</div>
<style type="text/css">
    .image-link img {
        max-height: 100px;
