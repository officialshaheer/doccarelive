<?php 
    ...
    $db=new Database(); 
    if( isset( $_GET['id'] ) ) {
        $sql='select * from doctors where doctor_id = "' . $_GET['id'] .  '" and employee_id = ' . $_COOKIE['userid'] ; 
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-bordered">
            <div class="panel-heading">
                <h3 class="panel-title">View Doctor</h3>
    ...
    <?php } else { echo '<div class="alert alert-danger">No Doctor found</div>';} ?>
