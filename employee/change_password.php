...
<?php 
	...
	if( isset( $_POST['register'] ) ) {
        $sql = 'select * from employee where password = :password and employee_id = :employee_id';
        $params = array(
        ...
        if( $db->display($sql, $params) ) {
            ...
            $sql = 'update employee set password = :password where employee_id = ' . $_COOKIE['userid'];
            $params = array(
